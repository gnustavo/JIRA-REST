...
CAUTION - THIS IS STILL ALPHA CODE
...
This module is a thin wrapper around L<JIRA's REST
API|https://docs.atlassian.com/jira/REST/latest/>, which is
superseding it's old L<SOAP
